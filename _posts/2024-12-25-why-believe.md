...
There are so many religions out there - why would we consider Christianity the "right one"? Why would it be better than any of the others? Some even say that "all religions are equal", but what does that mean? Are all belief systems truly equal? Would you equate democracy, freedom, individual rights, with ideologies that enforce oppression and control? Similarly, should a religion that advocates peace and forgiveness be placed on the same level as one that justifies retribution and violence in the name of that faith?

This is all subjective of course as it depends on each of our core values, proving once again how important they are. But for anyone who agrees that love, forgiveness, and kindness are cardinal values in life that lead to a better world, less suffering, and personal fulfillment, Christianity is the rational choice - simply because these are the cardinal values of Jesus.
